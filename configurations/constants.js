...
class Constants {
    constructor({}) {
        ...
        this.message_after_repeated_succes_charge = {
            QDfC: `Goonj tv Rs.5 ap ka mobile balance sa renew kr de gae ha. Daikhny ka lye click https://goonj.pk or Khatam krny ka lye https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,
            QDfG: `Goonj tv Rs.15 ap ka mobile balance sa renew kr de gae ha. Daikhny ka lye click https://goonj.pk or Khatam krny ka lye https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,                            
            QDfH: `Ap Pakistan ki best Comedy Portal service istamal kar rahey hain. Service Deikhnay ya Package ki tabdeeli k liay click karein. https://goonj.pk/home`,
        ...
        this.message_after_first_successful_charge = {
            QDfC: `Goonj daily Live TV service Rs.5/day istamal krny ka shukria. Service dekhein https://goonj.pk or Unsub krny ka liya https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,
            QDfG: `Goonj weekly Live TV service Rs.15/week istamal krny ka shukria. Service dekhein https://goonj.pk or Unsub krny ka liya https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,                           
            QDfH: `Ap Pakistan ki best Comedy Portal service istamal kar rahey hain. Service Deikhnay ya Package ki tabdeeli k liay click karein. https://goonj.pk/home`,
            QDfI: `Ap Pakistan ki best Comedy Portal service istamal kar rahey hain. Service Deikhnay ya Package ki tabdeeli k liay click karein. https://goonj.pk/home`
        }
